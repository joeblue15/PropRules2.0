    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--background)] px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6">
          ...
          <button
            onClick={signIn}
            className="w-full flex items-center justify-center gap-3 py-2.5 px-4 rounded-xl border border-[var(--border)] bg-[var(--background)] hover:bg-[var(--surface-hover)] transition-colors text-sm font-medium text-[var(--foreground)]"
          >
